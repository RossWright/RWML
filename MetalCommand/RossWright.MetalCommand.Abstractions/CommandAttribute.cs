...
public sealed class CommandAttribute(string name, params string[] invocations) : Attribute
{
    ...
    /// <summary>
    /// Category group shown in the help screen. Commands with the same category are listed together.
    /// Commands without a category appear under "Uncategorized" at the end.
    /// The built-in "Console" category is always listed first.
    /// </summary>
